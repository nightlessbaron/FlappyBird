...
display.set_caption('Flappy Bird Riped')
clock = time.Clock()

ground = windowY - 100

# Checks the input after each click of mouse or space bar
old_states = {
    'mouse': 0,
    'space': 0}
...
images = {
    ...
    'background': image.load('flap8.jpg'),
...
class Flappy_Class:
    ...
    def __init__(self):
        ...
        self.width, self.height = scale * 18, scale * 13
        
        self.flap_1 = transform.scale(image.load('flap1.png'), (self.width, self.height))
        self.flap_2 = transform.scale(image.load('flap10.png'), (self.width, self.height))
        self.flap_3 = transform.scale(image.load('flap9.png'), (self.width, self.height))
